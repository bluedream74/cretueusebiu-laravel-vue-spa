  ...
  export default {
    ...
    methods: {
      init() {
        ...
        this.department_name = localStorage.getItem('department_name') == 'null' ? '' : localStorage.getItem('department_name')
        ...
        this.city = localStorage.getItem('city') == 'null' ? '' : localStorage.getItem('city')
        this.building = localStorage.getItem('building') == 'null' ? '' : localStorage.getItem('building')
        this.telephone = localStorage.getItem('telephone') == 'null' ? '' : localStorage.getItem('telephone')
        this.fax = localStorage.getItem('fax') == 'null' ? '' : localStorage.getItem('fax')

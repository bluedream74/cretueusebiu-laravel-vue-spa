...
export default {
  ...
  created() {
		...
		$('meta[name=description]').attr('事業者×支援機関マッチングサイト補助金活用.COMの「支援機関ログイン」ページです。当サイトにて支援機関者登録が完了されている方は、会員情報を入力しマイページへログインしてください。パスワードを忘れた方、会員登録済み出ない方は専用フォームをご利用ください。')
	},
  mounted() {
  },
  methods: {

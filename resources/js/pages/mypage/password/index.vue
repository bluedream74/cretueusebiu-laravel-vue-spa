...
export default {
  ...
  created() {
    ...
    $('meta[name=og:description]').attr('content','事業者×支援機関マッチングサイト補助金活用.COMの「パスワードの再設定」ページです。支援機関登録済みの方がマイページへログインするためのパスワードを、入力した新規パスワードに変更します。新規パスワードは確認のため2回入力してください。')
  },
  methods: {

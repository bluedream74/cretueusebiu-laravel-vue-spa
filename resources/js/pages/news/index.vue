...
export default {
  ...
  created() {
    ...
    $('meta[name=description]').attr('content','事業者×支援機関マッチングサイト補助金活用.COMの「お知らせ一覧」ページです。当サイトからの事業者・支援機関様へ向けたお知らせ情報を、掲載日付順にご覧いただけます。お知らせの詳細等についてはリスト内の各リンクをご参照ください。')
    $('meta[name=og:description]').attr('content','事業者×支援機関マッチングサイト補助金活用.COMの「お知らせ一覧」ページです。当サイトからの事業者・支援機関様へ向けたお知らせ情報を、掲載日付順にご覧いただけます。お知らせの詳細等についてはリスト内の各リンクをご参照ください。')
  },
  mounted() {
    this.init()
  },
